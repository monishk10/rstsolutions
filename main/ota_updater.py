    ...
    def download_and_install_update_if_available(self):
        ...
        if 'next' in os.listdir(self.working_dir):
            if '.version_on_reboot' in os.listdir(self.working_dir + 'next'):
                self.download_all_files(self.github_repo + '/contents/main', latest_version)
                self.rmtree(self.working_dir + 'main')
                os.rename(self.working_dir + 'next/.version_on_reboot', self.working_dir + 'next/.version')
