    ...
    def upload_data(self):
        if (self.lines > 0):
            ...
            while (self.lines > 0):
                ...
                with open('/home/pi/rstsolutions/cache.txt', 'w') as file:
